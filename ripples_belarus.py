...
if __name__ == "__main__":
    ...
    for dist in range(distMin, distMax + 1, 1):
        ...
        frame = f"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}/dist={dist:05d}_Belarus.png"
    ...
    print(f"Making \"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}_Belarus.mp4\" ...")
    ...
    shutil.move(vname, f"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}_Belarus.mp4")
    ...
    for maxSize in maxSizes:
        print(f"Making \"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}_Belarus{maxSize:04d}px.mp4\" ...")
        ...
        shutil.move(vname, f"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}_Belarus{maxSize:04d}px.mp4")
