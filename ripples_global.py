...
if __name__ == "__main__":
    ...
    print(f"Making \"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}.mp4\" ...")
    ...
    shutil.move(vname, f"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}.mp4")
    ...
    for maxSize in maxSizes:
        print(f"Making \"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}{maxSize:04d}px.mp4\" ...")
        ...
        shutil.move(vname, f"{outDir}/lon={lon:+011.6f}_lat={lat:+010.6f}{maxSize:04d}px.mp4")
